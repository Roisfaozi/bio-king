      ...
      <CardHeader className='mb-0 border-none p-6'>
        <div className='flex flex-wrap justify-between gap-4'>
          <div className='flex-1'>
            <div className='whitespace-nowrap text-lg font-medium text-default-900'>
              Project Files
            </div>
            <div className='whitespace-nowrap text-xs font-medium text-default-600 lg:text-sm'>
          ...
          <div className='flex flex-wrap items-center gap-4'>
            ...
            <div className='relative'>
              <Search className='absolute top-1/2 h-4 w-4 -translate-y-1/2 text-default-400 ltr:left-2 rtl:right-2' />
      ...
      <CardContent>
        {fileView === 'grid' && (
          <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5'>
            {files?.map((item, i) => <SingleFileCard item={item} key={i} />)}
          </div>
        )}
