    ...
    >
      <div className='flex items-center gap-1.5'>
        ...
        <div
          ...
          className={cn(
            'text inline-flex cursor-pointer items-center gap-3 rounded px-3 py-3 text-base font-medium transition-all duration-200 data-[open=true]:bg-default-200/80 [&_.menu-arrow>svg]:h-4 [&_.menu-arrow>svg]:w-4',
            className,
          )}
