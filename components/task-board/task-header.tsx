  ...
  return (
    <div className='flex flex-wrap items-center gap-4'>
      <div className='flex flex-1 items-center gap-4'>
        ...
        <div className='relative'>
          <Icon
            ...
            className='absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-default-600'
          />
          <Select>
      ...
      <div className='flex flex-none items-center gap-4'>
        <div className='relative'>
          <span className='absolute right-2.5 top-1/2 flex h-full w-8 -translate-y-1/2 items-center justify-center border-l border-default-200 text-default-600'>
        ...
        <Button onClick={openCreateBoard}>
          <Plus className='h-4 w-4 ltr:mr-1 rtl:ml-1' /> Create Board
        </Button>
      </div>
    </div>
  );
